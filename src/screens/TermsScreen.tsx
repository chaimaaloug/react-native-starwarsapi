  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View>
            ...
            <Title style={styles.title}>1. Account</Title>
            <Text style={styles.content}>
            ...
            <Title style={styles.title}>2. Service</Title>
            <Text style={styles.content}>
            ...
            <Title style={styles.title}>3. Privacy</Title>
            <Text style={styles.content}>
            ...
            <Title style={styles.title}>4. Content</Title>
            <Text style={styles.content}>
